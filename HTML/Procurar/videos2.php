...
<div id="conteudo">
	<div id="coluna1">
			<?php
            	if($_SESSION["tipo"] == 2)
				{
					echo '<a href="../banda/Profile/bandprofile.php?id='.$_SESSION["codigo"].'"><img id="foto_user2" src="../Usuarios/'.$_SESSION["foto_perfil"].'" /> </a>';
				}
				else
				{
					...
					if($_SESSION["tipo"] == 3)
					{
						echo '<a href="../visitante/index.php"><img id="foto_user2" src="../Usuarios/'.$_SESSION["foto_perfil"].'" /> </a>';
					}
					else
					{
						...
						if($_SESSION["tipo"] == 4)
						{
							echo '<a href="../produtor/ranque/index.php"><img id="foto_user2" src="../Usuarios/'.$_SESSION["foto_perfil"].'" /> </a>';
						}
					}
