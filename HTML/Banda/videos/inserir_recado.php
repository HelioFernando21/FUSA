...
<?php
	...
	if ($atualizacao != $_SESSION["codigo"])
	{
			...
			$sql = mysql_query("insert into atualizacoes values('Há;;e;;novo(s) comentario(s) sobre seu video ".$NmVideo.";;e;;/Fusa/HTML/Banda/videos/index.php?id=',".$atualizacao.",0,null,1,".$video.",1,".$_SESSION["codigo"].",".$Maior.");") or die;
