...
<?php
	...
	{
			$sql = mysql_query("insert into atualizacoes values('Há;;e;;novo(s) lyrics ;;e;;/Fusa/HTML/Solo/lyrics/index.php?id=',".$atualizacao_lyrics.",0,null,2,".$lyrics.",1,".$_SESSION["codigo"].",".$Maior.");") or die;					
	}
	mysql_close($conecta);
