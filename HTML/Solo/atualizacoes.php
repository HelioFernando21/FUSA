...
cd_tipo_atualizacao,cd_link FROM atualizacoes where (cd_usuario = ".$codigo_pagina.") and (cd_situacao_atualizacao = 0)  group by cd_tipo_atualizacao,cd_link;") or die;
				while($linha = mysql_fetch_array($sql))
				{
					...
					if ($cdSituacao == 0)
					{
						echo utf8_encode('<div id="conteudo_atualizacao" style="
						background-image:url(../../Design/NAOVIU.png); 
						width:304px; 
						height:35px;
						margin-left:auto;
						margin-right:auto;						
					...
					{
						echo utf8_encode('<div id="conteudo_atualizacao" style="
						background-image:url(../../Design/2VIU2.png); 
						width:304px; 
						height:35px;
						margin-left:auto;
						margin-right:auto;	
