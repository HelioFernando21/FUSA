...
<?php
				...
				if ($qt == 0)
				{
					...
					{
								$sql = mysql_query("insert into atualizacoes values('Há;;e;;nova(s) curtida(s) sobre seu video;;e;;/Fusa/HTML/Solo/videos/index.php?id=',".$cdusuario.",0,null,3,".$video.",1,".$_SESSION["codigo"].",".$Maior.");") or die;
					}
