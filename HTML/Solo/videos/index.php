...
while (str.indexOf("\n") != -1)
	...
	pesquisa(v,str);
	jAlert('Comentário efetuado com sucesso!');
...
<?php
	...
	?>
			...
			<div id="coluna1">
			<?php echo '<a href="../Profile/profile.php?id='.$cdUsuario.'"><img src="../../Usuarios/'.$FotoPerfil.'" id="foto_user" /></a> '; ?>
...
<div id="segura_conteudo">
    ...
    <div id="title_video"><p class="p_name_big"><?php echo  $NmVideo;  ?></p></div>
...
<a href="../../Rodape/sobreafusa.php" class="float2"><p class="space2">Sobre a Fusa -</p></a>  
<a href="../../Rodape/produtores.php" class="float2"><p class="color2">Produtores -</p></a>
<a href="../../Rodape/contato.php" class="float2"><p class="color2">Contato</p></a>
